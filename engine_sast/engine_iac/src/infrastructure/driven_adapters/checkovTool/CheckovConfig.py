...
class CheckovConfig:
    ...
    def create_config_dict(self):
        if self.compact is not None:
            ...
            raise ValueError(
                "El valor" + CheckovConfigEnum.COMPACT.value + "no puede ser nulo"
            )
        ...
        if self.quiet is not None:
            ...
            raise ValueError(
                "El valor" + CheckovConfigEnum.QUIET.value + "no puede ser nulo"
            )
        ...
        if self.checks is not None:
            ...
            raise ValueError(
                "El valor" + CheckovConfigEnum.CHECKS.value + "no puede ser nulo"
            )
        ...
        if self.output is not None:
            ...
            raise ValueError(
                "El valor" + CheckovConfigEnum.OUTPUT.value + "no puede ser nulo"
            )
        ...
        if self.directories is not None:
            ...
            raise ValueError(
                "El valor" + CheckovConfigEnum.DIRECTORIES.value + "no puede ser nulo"
            )
