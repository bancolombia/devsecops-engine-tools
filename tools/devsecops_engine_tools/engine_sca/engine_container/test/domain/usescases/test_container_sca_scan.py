...
@pytest.fixture
def container_sca_scan(mock_tool_run, mock_tool_remote, mock_tool_images, mock_tool_deserializator, mock_tool_build_id):
    dict_args = {"remote_config_repo": "path_to_config"}
    return ContainerScaScan(mock_tool_run, mock_tool_remote, mock_tool_images, mock_tool_deserializator, mock_tool_build_id, "token")
