...
def init_engine_sca_rm( tool_run,tool_images,tool_deseralizator,tool_images_scanned,dict_args, token):

    Printers.print_logo_tool()
   
    container_sca_scan = ContainerScaScan(tool_run,tool_images,tool_deseralizator,tool_images_scanned,dict_args,token)
