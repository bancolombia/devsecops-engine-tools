...
class AddData:
    ...
    def download_epss_data():
        ...
        logger.error("Could not find EPSS data from de last 2 days. Skipping add EPS data...")
        return None
    ...
    def add_data(self):
        needs_epss_update = any(finding.vul_id[:3] == "CVE" and finding.epss_score == 0 for finding in self.findings)
