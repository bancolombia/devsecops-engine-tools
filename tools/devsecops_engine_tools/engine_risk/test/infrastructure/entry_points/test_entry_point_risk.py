...
from devsecops_engine_tools.engine_risk.src.infrastructure.entry_points.entry_point_risk import init_engine_risk
...
def test_init_engine_risk_no_findigs(mock_print):
    ...
    mock_print.assert_called_with("No Findings found in Vulnerability Management Platform")