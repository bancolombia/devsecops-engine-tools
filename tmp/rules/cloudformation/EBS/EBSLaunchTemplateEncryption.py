...
class EBSLaunchTemplateEncryption(BaseResourceCheck):
    def __init__(self):
        name = "Ensure all data stored in the EBS LaunchTemplate is securely encrypted"
        id = "CKV_AWS_272"
...
check = EBSLaunchTemplateEncryption()