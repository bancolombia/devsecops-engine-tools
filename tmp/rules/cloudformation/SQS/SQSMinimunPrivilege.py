...
class SQSMinimumPrivilege(BaseResourceCheck):
    def __init__(self):
        name = "Ensure SQS policies documents dont allow \"*\" as a statement's actions and Resources"
        id = "CKV_AWS_361"
