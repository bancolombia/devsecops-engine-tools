...
SETTING_LOGGER = {"debug": DEBUG, "log_file": False}
...
TOKEN_CMDB = config(
    "TOKEN_CMDB", default="https://55v20mng66.execute-api.us-east-1.amazonaws.com/dev/aws-inventory", cast=str
)
HOST_CMDB = config("HOST_CMDB", default="4n9bde64nd07ebcu86shbco7m39n0", cast=str)
