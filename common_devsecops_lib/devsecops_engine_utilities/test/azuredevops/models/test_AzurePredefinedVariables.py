...
@pytest.mark.parametrize(
    ...
    [
        (SystemVariables.System_AccessToken,
         "SYSTEM_ACCESSTOKEN", "AccessTokenValue"),
        (SystemVariables.System_CollectionId,
         "SYSTEM_COLLECTIONID", "CollectionIdValue"),
        (
        ...
        (BuildVariables.Build_DefinitionName,
         "BUILD_DEFINITIONNAME", "DefinitionNameValue"),
        (BuildVariables.Build_Repository_Name,
         "BUILD_REPOSITORY_NAME", "RepositoryNameValue"),
        (BuildVariables.Build_SourceBranch,
         "BUILD_SOURCEBRANCH", "SourceBranchValue"),
        (ReleaseVariables.Artifact_Path, "ARTIFACT_PATH", "ArtifactPathValue"),
    ],
)
def test_enum_env_name(monkeypatch, enum_class,
                       expected_env_name, expected_value):
