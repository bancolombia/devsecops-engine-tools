...
from common_devsecops_lib.devsecops_engine_utilities.github.infrastructure.github_api import GithubApi
...
class TestGithubApi(unittest.TestCase):
    ...
    @patch('common_devsecops_lib.devsecops_engine_utilities.github.infrastructure.github_api.zipfile.ZipFile')
    ...
    @patch('common_devsecops_lib.devsecops_engine_utilities.github.infrastructure.github_api.requests.get')
    @patch('common_devsecops_lib.devsecops_engine_utilities.github.infrastructure.github_api.GithubApi.unzip_file')
