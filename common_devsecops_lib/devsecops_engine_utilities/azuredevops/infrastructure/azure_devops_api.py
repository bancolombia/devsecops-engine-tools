...
class AzureDevopsApi:
    def __init__(self, personal_access_token: str,
                 project_remote_config: str, organization_url: str):
    ...
    def get_azure_connection(self) -> Connection:
        try:
            credentials = BasicAuthentication(
                username="", password=self.__personal_access_token)
    ...
    def get_remote_json_config(
            self, connection: Connection, repository_id, remote_config_path):
        try:
