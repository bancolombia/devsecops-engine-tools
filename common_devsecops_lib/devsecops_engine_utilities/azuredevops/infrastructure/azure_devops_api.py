...
class AzureDevopsApi:
    def __init__(self, personal_access_token: str, project_remote_config: str, organization_url: str):
    ...
    def get_remote_json_config(self, connection: Connection, repository_id, remote_config_path):
        try:
            git_client = connection.clients.get_git_client()
            file_content = git_client.get_item_text(
                repository_id=repository_id, path=remote_config_path, project=self.__project_remote_config
            )
